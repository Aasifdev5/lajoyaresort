                                        ...
                                        <div class="elementor-widget-container">
                                            <a href="{{ url('/') }}" id="trx_sc_layouts_logo_2013124363"
                                                ...
                                                <img loading="lazy" class="logo_image"
                                                    ...
                                                    alt="Neptunus" width="210" height="47">
                                            </a>
                                            <!-- /.sc_layouts_logo -->
                                        </div>
                                    </div>
                                                ...
                                                <ul id="menu_main" class="sc_layouts_menu_nav menu_main_nav">
                                                    ...
                                                    <li id="menu-item-305"
                                                        ...
                                                        <ul class="sub-menu" style="display: none;">
                                                            ...
                                                            <li id="menu-item-304"
                                                                class="menu-item menu-item-type-post_type menu-item-object-page menu-item-304">
                                                                <a href="{{ url('vacancy') }}">
                                                                    <span>Vacaciones Inteligentes por Vacancy
                                                                        Rewards</span>
                                                                </a>
                                                            </li>
                                                        </ul>
                                                                                                            ...
                                                                                                            <a href="{{ url('dashboard') }}"
                                                                                                                ...
                                                                                                                @if (!empty($user_session->profile_photo))
                                                                                                                    <img src="{{ asset('profile_photo/') }}<?php        echo '/' . $user_session->profile_photo; ?>"
                                                                                                                        ...
                                                                                                                        alt="{{ $user_session->name }}" width="24" height="24">

                                                                                                                    <span>{{ $user_session->name  }}</span>
                                                                                                                @else
                                                                                                                    <img src="{{ asset('149071.png') }}" alt="Perfil"
                ...
                <div class="menu_mobile_inner">
                    ...
                    <a class="sc_layouts_logo" href="{{ url('index') }}">
                        <img loading="lazy" src="{{ asset($general_setting['app_logo'] ?? '') }}"
                            srcset="{{ asset($general_setting['app_logo'] ?? '') }}" alt="Neptunus" width="210"
                            height="47">
                    </a>
       ...
       <span class="fab fa-tiktok"></span>
            ...
            <footer class="footer_wrap footer_custom footer_custom_1433 footer_custom_footer-light">
                <div data-elementor-type="cpt_layouts" data-elementor-id="1433" class="elementor elementor-1433">
                                                ...
                                                <div class="menu-services-container">
                                                    <ul id="menu-services" class="menu">
                                                        <li id="menu-item-2818"
                                                            ...
                                                            <a href="{{ url('membership') }}">Membresía Vitalicia La
                                                                Joya</a>
                                                        </li>
                                                        <li id="menu-item-2818"
                                                            class="menu-item menu-item-type-custom menu-item-object-custom menu-item-2818">
                                                        ...
                                                        <li id="menu-item-2818"
                                                            class="menu-item menu-item-type-custom menu-item-object-custom menu-item-2818">
                                                            <a href="{{ url('vacancy') }}">Vacaciones Inteligentes por
                                                                Vacancy Rewards</a>
                                                        </li>
                                                    </ul>
                                                </div>
                                            ...
                                            <aside id="wp-widget-nav_menu-3" class="widget wp-widget-nav_menu">
                                                <div class="menu-about-container">
                                                    <div class="sc_icons_item_details">
                                                        ...
                                                        <div
                                                            class="menu-item menu-item-type-custom menu-item-object-custom menu-item-2818">
                                                            <span id="menu-item-2818"
                                                                style="font-weight: 800;font-size: 14px;">
                                                                2DO ANILLO Y AVENIDA SAN MARTÍN, TORRE EQUIPETROL.
                                                                PLANTA BAJA.
                                                            </span>
                                                        </div>
                                                        <a href="https://maps.app.goo.gl/ZGXrxYLhRrXt8rwT7"
                                                            target="_blank">
                                                            <button
                                                                style="margin-top:10px; padding:10px; background-color:#007bff; color:#fff; border:none; border-radius:5px; cursor:pointer;">
                                                                Dirección Oficina
                                                            </button>
                                                        </a>
                                                    </div>
                                                    ...
                                                    <div class="sc_icons_item_details">
                                                        ...
                                                        <div
                                                            ...
                                                            <span style="font-weight: 800;font-size: 14px;">
                                                                DÉCIMO ANILLO, AVENIDA TRES PASOS AL FRENTE A 1 KM DEL
                                                                PARQUE DE LOS RECUERDOS
                                                            </span>
                                                        </div>
                                                        <a href="https://maps.app.goo.gl/azAnnLdy3DLzFG5D8"
                                                            target="_blank">
                                                            <button
                                                                style="margin-top:10px; padding:10px; background-color:#28a745; color:#fff; border:none; border-radius:5px; cursor:pointer;">
                                                                Dirección Parque
                                                            </button>
                                                        </a>
                                                    </div>
                    ...
                    <!-- Footer Copyright -->
                    <section
                        class="elementor-section elementor-top-section elementor-element elementor-element-2c5474a4 elementor-section-content-middle scheme_default elementor-section-boxed elementor-section-height-default elementor-section-height-default"
                                ...
                                <div class="elementor-widget-wrap elementor-element-populated">
                                    <div class="sc_layouts_item elementor-element elementor-element-166a1128 sc_fly_static elementor-widget elementor-widget-text-editor"
                                        ...
                                        <div class="elementor-widget-container">
                                            ...
                                            <span
                                                style="font-size: 14px; font-style: normal; font-weight: 800; text-transform: uppercase;">©</span>
                                            <span
                                                style="font-size: 14px; text-transform: uppercase; font-weight: 800;">{{ now()->year }}.
                                        ...
                                        <div class="elementor-widget-container">
                                            <div id="trx_sc_socials_1535176462"
                                                ...
                                                <div class="socials_wrap">
                                                    ...
                                                    <a target="_blank"
                                                        href="{{ $general_setting['youtube_url'] ?? '' }}"
                                                        class="social_item social_item_style_icons sc_icon_type_icons social_item_type_icons">
                                                        <span class="social_icon social_icon_youtube">
                                                            <span class="icon-youtube"></span>
                                                        </span>
...
<a target="_blank"
   ...
   <span class="social_icon social_icon_tiktok">
    ...
    <script type="text/javascript" src="{{ asset('js/jquery.tooltipster.min.js') }}"
    ...
    <script type="text/javascript" src="{{ asset('js/add-to-cart.min.js') }}" id="wc-add-to-cart-js" defer="defer"
        data-wp-strategy="defer"></script>
    <script type="text/javascript" src="{{ asset('js/js.cookie.min.js') }}" id="js-cookie-js" defer="defer"
        data-wp-strategy="defer"></script>

    <script type="text/javascript" src="{{ asset('js/woocommerce.min.js') }}" id="woocommerce-js" defer="defer"
        data-wp-strategy="defer"></script>
    ...
    <script type="text/javascript" src="{{ asset('js/frontend-functions.js') }}"
    ...
    <script type="text/javascript" src="{{ asset('js/order-attribution.min.js') }}"
    ...
    <script type="text/javascript" src="{{ asset('js/mediaelement-and-player.min.js') }}"
        id="mediaelement-core-js"></script>
    <script type="text/javascript" src="{{ asset('js/mediaelement-migrate.min.js') }}"
        id="mediaelement-migrate-js"></script>

    <script type="text/javascript" src="{{ asset('js/wp-mediaelement.min.js') }}" id="wp-mediaelement-js"></script>

    <script type="text/javascript" src="{{ asset('js/cart-fragments.min.js') }}" id="wc-cart-fragments-js" defer="defer"
        data-wp-strategy="defer"></script>
    <script type="text/javascript" src="{{ asset('js/webpack.runtime.min.js') }}"
        id="elementor-webpack-runtime-js"></script>
    <script type="text/javascript" src="{{ asset('js/frontend-modules.min.js') }}"
